...
}`,r.ShadersStoreWGSL[_]||(r.ShadersStoreWGSL[_]=v),y=[s,d,c,a,p,m];for(let e of y)r.IncludesShadersStoreWGSL[e.name]||(r.IncludesShadersStoreWGSL[e.name]=e.shader);b={name:_,shader:v}}));export{b as n,g as r,x as t};