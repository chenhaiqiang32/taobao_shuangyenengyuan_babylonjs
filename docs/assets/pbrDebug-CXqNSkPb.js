import{n as e}from"./rolldown-runtime-B0Z9INg1.js";import{n as t,t as n}from"./shaderStore-DBiNfWDC.js";import{t as r}from"./ltcHelperFunctions-BpuHxZQ1.js";import{t as i}from"./mainUVVaryingDeclaration-BlaxkZjG.js";var a,o,s,c=e((()=>{t(),i(),a=`pbrFragmentExtraDeclaration`,o=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`,n.IncludesShadersStore[a]||(n.IncludesShadersStore[a]=o),s={name:a,shader:o}})),l,u,d,f=e((()=>{t(),l=`pbrHelperFunctions`,u=`#define MINIMUMVARIANCE 0.0005
...
#endif
`,n.IncludesShadersStore[l]||(n.IncludesShadersStore[l]=u),d={name:l,shader:u}})),p,m,h,g=e((()=>{t(),r(),p=`pbrDirectLightingSetupFunctions`,m=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`,n.IncludesShadersStore[p]||(n.IncludesShadersStore[p]=m),h={name:p,shader:m}})),_,v,y,b=e((()=>{t(),_=`pbrDirectLightingFalloffFunctions`,v=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`,n.IncludesShadersStore[_]||(n.IncludesShadersStore[_]=v),y={name:_,shader:v}})),x,S,C,w=e((()=>{t(),x=`pbrDirectLightingFunctions`,S=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`,n.IncludesShadersStore[x]||(n.IncludesShadersStore[x]=S),C={name:x,shader:S}})),T,E,D,O=e((()=>{t(),T=`pbrBlockNormalGeometric`,E=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`,n.IncludesShadersStore[T]||(n.IncludesShadersStore[T]=E),D={name:T,shader:E}})),k,A,j,M=e((()=>{t(),k=`pbrBlockImageProcessing`,A=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`,n.IncludesShadersStore[k]||(n.IncludesShadersStore[k]=A),j={name:k,shader:A}})),N,P,F,I=e((()=>{t(),N=`pbrDebug`,P=`#if DEBUGMODE>0
...
#endif
`,n.IncludesShadersStore[N]||(n.IncludesShadersStore[N]=P),F={name:N,shader:P}}));export{O as a,C as c,g as d,h as f,s as g,c as h,j as i,b as l,d as m,F as n,D as o,f as p,M as r,w as s,I as t,y as u};