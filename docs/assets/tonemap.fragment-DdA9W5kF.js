import{n as e,r as t}from"./rolldown-runtime-B0Z9INg1.js";import{n,t as r}from"./shaderStore-DBiNfWDC.js";var i=t({tonemapPixelShader:()=>s}),a,o,s,c=e((()=>{n(),a=`tonemapPixelShader`,o=`varying vec2 vUV;uniform sampler2D textureSampler;uniform float _ExposureAdjustment;
...
#endif
gl_FragColor=vec4(colour.rgb,1.0);}`,r.ShadersStore[a]||(r.ShadersStore[a]=o),s={name:a,shader:o}}));export{s as n,i as r,c as t};