...
`,n.ShadersStoreWGSL[F]||(n.ShadersStoreWGSL[F]=I),L=[i,v,y,p,u,S,N,d,C,o,E,c,k,O,h,j];for(let e of L)n.IncludesShadersStoreWGSL[e.name]||(n.IncludesShadersStoreWGSL[e.name]=e.shader);R={name:F,shader:I}}))();export{R as terrainVertexShaderWGSL};