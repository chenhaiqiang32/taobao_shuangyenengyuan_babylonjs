import{n as e}from"./rolldown-runtime-B0Z9INg1.js";import{n as t,t as n}from"./shaderStore-DBiNfWDC.js";import{r,t as i}from"./helperFunctions-DIiOqH-9.js";import{n as a,t as o}from"./subSurfaceScatteringFunctions-CjcY_plt.js";var s,c,l,u=e((()=>{t(),s=`fibonacci`,c=`#define rcp(x) 1./x
#define GOLDEN_RATIO 1.618033988749895
vec2 Golden2dSeq(int i,float n)
{return vec2(float(i)/n+(0.5/n),fract(float(i)*rcp(GOLDEN_RATIO)));}
vec2 SampleDiskGolden(int i,int sampleCount)
{vec2 f=Golden2dSeq(i,float(sampleCount));return vec2(sqrt(f.x),TWO_PI*f.y);}`,n.IncludesShadersStore[s]||(n.IncludesShadersStore[s]=c),l={name:s,shader:c}})),d,f,p,m=e((()=>{t(),d=`diffusionProfile`,f=`uniform vec3 diffusionS[5];uniform float diffusionD[5];uniform float filterRadii[5];`,n.IncludesShadersStore[d]||(n.IncludesShadersStore[d]=f),p={name:d,shader:f}})),h,g,_,v;e((()=>{t(),r(),u(),o(),m(),h=`subSurfaceScatteringPixelShader`,g=`#include<helperFunctions>
#include<fibonacci>
...
totalWeight=max(totalWeight,HALF_MIN);gl_FragColor=vec4(inputColor.rgb+albedo*max(totalIrradiance/totalWeight,vec3(0.0)),1.);}`,n.ShadersStore[h]||(n.ShadersStore[h]=g),_=[i,l,a,p];for(let e of _)n.IncludesShadersStore[e.name]||(n.IncludesShadersStore[e.name]=e.shader);v={name:h,shader:g}}))();export{v as subSurfaceScatteringPixelShader};