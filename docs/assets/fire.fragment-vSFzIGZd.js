...
}`,n.ShadersStore[y]||(n.ShadersStore[y]=b),x=[o,p,c,i,g,l,f,v];for(let e of x)n.IncludesShadersStore[e.name]||(n.IncludesShadersStore[e.name]=e.shader);S={name:y,shader:b}}))();export{S as firePixelShader};