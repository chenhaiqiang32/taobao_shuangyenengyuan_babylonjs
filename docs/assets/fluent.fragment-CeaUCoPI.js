import{n as e,r as t}from"./rolldown-runtime-B0Z9INg1.js";import{n,t as r}from"./shaderStore-DBiNfWDC.js";var i=t({fluentPixelShader:()=>s}),a,o,s,c=e((()=>{n(),a=`fluentPixelShader`,o=`precision highp float;varying vec2 vUV;uniform vec4 albedoColor;
#ifdef INNERGLOW
...
#endif
gl_FragColor=vec4(albedo,alpha);}`,r.ShadersStore[a]||(r.ShadersStore[a]=o),s={name:a,shader:o}}));export{c as n,i as t};