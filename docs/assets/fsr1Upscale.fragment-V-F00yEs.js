import{n as e,r as t}from"./rolldown-runtime-B0Z9INg1.js";import{n,t as r}from"./shaderStore-DBiNfWDC.js";import{n as i,t as a}from"./ffxFunctions-aMS_AQ9v.js";var o=t({fsr1UpscalePixelShader:()=>u}),s,c,l,u,d=e((()=>{n(),i(),s=`fsr1UpscalePixelShader`,c=`#include<ffxFunctions>
...
`,r.ShadersStore[s]||(r.ShadersStore[s]=c),l=[a];for(let e of l)r.IncludesShadersStore[e.name]||(r.IncludesShadersStore[e.name]=e.shader);u={name:s,shader:c}}));export{d as n,o as t};