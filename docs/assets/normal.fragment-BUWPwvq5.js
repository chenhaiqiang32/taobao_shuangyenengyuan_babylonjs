...
}`,n.ShadersStore[j]||(n.ShadersStore[j]=M),N=[m,_,y,x,T,o,C,c,i,O,h,l,f,A];for(let e of N)n.IncludesShadersStore[e.name]||(n.IncludesShadersStore[e.name]=e.shader);P={name:j,shader:M}}))();export{P as normalPixelShader};