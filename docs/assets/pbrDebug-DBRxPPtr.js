import{n as e}from"./rolldown-runtime-B0Z9INg1.js";import{n as t,t as n}from"./shaderStore-DBiNfWDC.js";import{t as r}from"./ltcHelperFunctions-DGwFuGAw.js";import{n as i}from"./clusteredLightingFunctions-y0WQqpNl.js";import{t as a}from"./mainUVVaryingDeclaration-DnaK2KSJ.js";var o,s,c,l=e((()=>{t(),a(),o=`pbrFragmentExtraDeclaration`,s=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`,n.IncludesShadersStoreWGSL[o]||(n.IncludesShadersStoreWGSL[o]=s),c={name:o,shader:s}})),u,d,f,p=e((()=>{t(),u=`pbrHelperFunctions`,d=`#define MINIMUMVARIANCE 0.0005
...
#endif
`,n.IncludesShadersStoreWGSL[u]||(n.IncludesShadersStoreWGSL[u]=d),f={name:u,shader:d}})),m,h,g,_=e((()=>{t(),r(),m=`pbrDirectLightingSetupFunctions`,h=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`,n.IncludesShadersStoreWGSL[m]||(n.IncludesShadersStoreWGSL[m]=h),g={name:m,shader:h}})),v,y,b,x=e((()=>{t(),v=`pbrDirectLightingFalloffFunctions`,y=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`,n.IncludesShadersStoreWGSL[v]||(n.IncludesShadersStoreWGSL[v]=y),b={name:v,shader:y}})),S,C,w,T=e((()=>{t(),S=`pbrBlockReflectance0`,C=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`,n.IncludesShadersStoreWGSL[S]||(n.IncludesShadersStoreWGSL[S]=C),w={name:S,shader:C}})),E,D,O,k=e((()=>{t(),T(),E=`pbrClusteredLightingFunctions`,D=`#if defined(CLUSTLIGHT{X}) && defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`,n.IncludesShadersStoreWGSL[E]||(n.IncludesShadersStoreWGSL[E]=D),O={name:E,shader:D}})),A,j,M,N=e((()=>{t(),i(),k(),A=`pbrDirectLightingFunctions`,j=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
#ifdef SS_TRANSLUCENCY
...
#endif
`,n.IncludesShadersStoreWGSL[A]||(n.IncludesShadersStoreWGSL[A]=j),M={name:A,shader:j}})),P,F,I,L=e((()=>{t(),P=`pbrBlockNormalGeometric`,F=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`,n.IncludesShadersStoreWGSL[P]||(n.IncludesShadersStoreWGSL[P]=F),I={name:P,shader:F}})),R,z,B,V=e((()=>{t(),R=`pbrBlockImageProcessing`,z=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`,n.IncludesShadersStoreWGSL[R]||(n.IncludesShadersStoreWGSL[R]=z),B={name:R,shader:z}})),H,U,W,G=e((()=>{t(),H=`pbrDebug`,U=`#if DEBUGMODE>0
...
#endif
`,n.IncludesShadersStoreWGSL[H]||(n.IncludesShadersStoreWGSL[H]=U),W={name:H,shader:U}}));export{p as _,L as a,c as b,M as c,T as d,w as f,g,_ as h,B as i,k as l,b as m,W as n,I as o,x as p,V as r,N as s,G as t,O as u,f as v,l as y};