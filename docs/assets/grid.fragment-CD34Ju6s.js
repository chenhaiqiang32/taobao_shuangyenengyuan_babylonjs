...
`,n.ShadersStoreWGSL[_]||(n.ShadersStoreWGSL[_]=v),y=[o,p,c,i,f,l,g];for(let e of y)n.IncludesShadersStoreWGSL[e.name]||(n.IncludesShadersStoreWGSL[e.name]=e.shader);b={name:_,shader:v}}))();export{b as gridPixelShaderWGSL};