import{n as e,r as ee}from"./rolldown-runtime-B0Z9INg1.js";import{n as t,t as n}from"./shaderStore-DBiNfWDC.js";import{r as te,t as ne}from"./bumpFragment-ZKEH1E7Q.js";import{n as re,t as ie}from"./samplerFragmentDeclaration-EP0koXA0.js";import{r as ae,t as oe}from"./bumpFragmentFunctions-AQfVwfXZ.js";import{r as se,t as ce}from"./bumpFragmentMainFunctions-CAzHhfZc.js";import{r as le,t as ue}from"./clipPlaneFragment-Birz0QQu.js";import{r as de,t as fe}from"./clipPlaneFragmentDeclaration-BeW0wzU5.js";import{r as pe,t as me}from"./fogFragmentDeclaration-Bnhxysih.js";import{n as he,t as ge}from"./logDepthFragment-DrurZwyM.js";import{n as _e,t as ve}from"./fogFragment-B7tBOW4n.js";import{r as ye,t as be}from"./harmonicsFunctions-DgCylLPg.js";import{r as xe,t as Se}from"./helperFunctions-DIiOqH-9.js";import{r as Ce,t as we}from"./imageProcessingDeclaration-CXLsq8po.js";import{r as Te,t as Ee}from"./imageProcessingFunctions-C8qEcvGI.js";import{n as De,t as Oe}from"./lightFragment-_152tcho.js";import{n as ke,t as Ae}from"./lightFragmentDeclaration-xXRmKbWC.js";import{n as je,t as Me}from"./lightUboDeclaration-D__UCulE.js";import{n as Ne,t as Pe}from"./ltcHelperFunctions-BpuHxZQ1.js";import{n as Fe,t as Ie}from"./clusteredLightingFunctions-Dsz_2Muy.js";import{n as Le,t as Re}from"./logDepthDeclaration-CXHAYacR.js";import{n as ze,t as Be}from"./reflectionFunction-CYt6SqVq.js";import{n as Ve,t as He}from"./shadowsFragmentFunctions-BDw1QEfW.js";import{n as Ue,t as We}from"./sceneUboDeclaration-DY0whaDI.js";import{a as Ge,c as Ke,i as qe,l as Je,n as Ye,o as Xe,r as Ze,s as Qe,t as $e,u as et}from"./oitFragment-Db3N6RUB.js";import{n as tt,t as nt}from"./meshUboDeclaration-DmH0C9dB.js";import{n as rt,t as it}from"./mainUVVaryingDeclaration-BlaxkZjG.js";import{n as at,t as ot}from"./decalFragment-ClBM55w3.js";import{n as st,t as ct}from"./depthPrePass-CgCyzsEz.js";import{i as lt,n as ut,r as dt,t as ft}from"./pbrIBLFunctions-DbBTfOiP.js";import{n as pt,t as mt}from"./pbrBRDFFunctions-B2sEeQXA.js";import{i as ht,n as gt,r as _t,t as vt}from"./hdrFilteringFunctions-DWD6nePe.js";import{a as yt,c as bt,d as xt,f as St,g as Ct,h as wt,i as Tt,l as Et,m as Dt,n as Ot,o as kt,p as At,r as jt,s as Mt,t as Nt,u as Pt}from"./pbrDebug-CXqNSkPb.js";import{n as Ft,t as It}from"./subSurfaceScatteringFunctions-CjcY_plt.js";import{n as Lt,t as Rt}from"./pbrUboDeclaration-B3M1Mg0c.js";var r,i,zt,Bt=e((()=>{t(),et(),r=`pbrFragmentDeclaration`,i=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
#endif
#endif
`,n.IncludesShadersStore[a]||(n.IncludesShadersStore[a]=o),Vt={name:a,shader:o}})),s,c,Ut,Wt=e((()=>{t(),ie(),Ht(),dt(),s=`pbrFragmentSamplersDeclaration`,c=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`,n.IncludesShadersStore[k]||(n.IncludesShadersStore[k]=A),fn={name:k,shader:A}})),j,M,mn,hn=e((()=>{t(),Fe(),pn(),j=`pbrClusteredLightingFunctions`,M=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
#endif
#endif
`,n.IncludesShadersStore[Y]||(n.IncludesShadersStore[Y]=X),Mn={name:Y,shader:X}})),Pn=ee({pbrPixelShader:()=>$}),Z,Q,Fn,$,In=e((()=>{t(),Qe(),Ge(),et(),Bt(),We(),nt(),Rt(),it(),wt(),Ae(),Me(),ie(),Ht(),dt(),Wt(),Ce(),de(),Re(),pe(),Ze(),xe(),It(),ht(),At(),Te(),He(),ye(),Pe(),xt(),Et(),mt(),gt(),Mt(),ft(),se(),ae(),Be(),at(),Kt(),Jt(),Xt(),Qt(),en(),nn(),an(),sn(),ln(),dn(),Fe(),pn(),hn(),le(),yt(),te(),_n(),st(),yn(),xn(),Cn(),Tn(),Oe(),Dn(),kn(),jn(),ge(),_e(),jt(),Nn(),$e(),Nt(),Z=`pbrPixelShader`,Q=`#define PBR_FRAGMENT_SHADER
...
`,n.ShadersStore[Z]||(n.ShadersStore[Z]=Q),Fn=[Ke,Xe,Je,zt,Ue,tt,Lt,rt,Ct,ke,je,re,Vt,lt,Ut,we,fe,Le,me,qe,Se,Ft,_t,Dt,Ee,Ve,be,Ne,St,Pt,pt,vt,bt,ut,ce,oe,ze,ot,Gt,qt,Yt,Zt,$t,tn,rn,on,cn,un,Ie,fn,mn,ue,kt,ne,gn,ct,vn,bn,Sn,wn,De,En,On,An,he,ve,Tt,Mn,Ye,Ot];for(let e of Fn)n.IncludesShadersStore[e.name]||(n.IncludesShadersStore[e.name]=e.shader);$={name:Z,shader:Q}}));export{$ as n,Pn as r,In as t};