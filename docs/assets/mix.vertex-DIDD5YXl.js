...
`,n.ShadersStoreWGSL[F]||(n.ShadersStoreWGSL[F]=I),L=[i,v,y,u,p,S,N,d,C,o,E,c,O,h,j,k];for(let e of L)n.IncludesShadersStoreWGSL[e.name]||(n.IncludesShadersStoreWGSL[e.name]=e.shader);R={name:F,shader:I}}))();export{R as mixVertexShaderWGSL};