...
}`,r.ShadersStore[_]||(r.ShadersStore[_]=v),y=[s,d,c,a,p,m];for(let e of y)r.IncludesShadersStore[e.name]||(r.IncludesShadersStore[e.name]=e.shader);b={name:_,shader:v}}));export{b as n,g as r,x as t};