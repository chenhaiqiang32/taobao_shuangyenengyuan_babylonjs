import{n as e,r as t}from"./rolldown-runtime-B0Z9INg1.js";import{n,t as r}from"./shaderStore-DBiNfWDC.js";import{n as i,t as a}from"./ffxFunctions-CaULbEiY.js";var o=t({fsr1UpscalePixelShaderWGSL:()=>u}),s,c,l,u,d=e((()=>{n(),i(),s=`fsr1UpscalePixelShader`,c=`#include<ffxFunctions>
...
`,r.ShadersStoreWGSL[s]||(r.ShadersStoreWGSL[s]=c),l=[a];for(let e of l)r.IncludesShadersStoreWGSL[e.name]||(r.IncludesShadersStoreWGSL[e.name]=e.shader);u={name:s,shader:c}}));export{d as n,o as t};