...
`,n.ShadersStore[F]||(n.ShadersStore[F]=I),L=[i,s,C,m,y,E,h,_,D,u,c,f,A,x,N,j];for(let e of L)n.IncludesShadersStore[e.name]||(n.IncludesShadersStore[e.name]=e.shader);R={name:F,shader:I}}))();export{R as mixVertexShader};