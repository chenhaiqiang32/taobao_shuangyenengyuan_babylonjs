...
`,n.ShadersStore[N]||(n.ShadersStore[N]=P),F=[i,s,C,m,y,E,h,_,D,u,c,f,j,A,x];for(let e of F)n.IncludesShadersStore[e.name]||(n.IncludesShadersStore[e.name]=e.shader);I={name:N,shader:P}}))();export{I as normalVertexShader};